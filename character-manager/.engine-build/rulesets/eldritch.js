...
exports.eldritch = void 0;
/** Most Eldritch skills are three tiers of flat cost, each needing the last. */
function ladder(id, name, groupId, cost, tags = [], descriptions) {
...
exports.eldritch = {
    ...
    name: 'Eldritch',
    version: '2026',
    description: 'A live action roleplaying game set in the Kingdom of Arnesse. Events take place in the Annwyn.',
    ...
    packages: [
        ...
        },
        {
            ...
            attributes: {
                startingEquipment: '2 Apothecary Kits, 4 level 1 apothecary schematics, and resources to craft two',
    ...
    purchaseRules: [
        {
            ...
            message: 'You may not purchase more than level 1 of any crafting skill at character creation.',
            phase: 'creation',
        ...
        },
        {
            ...
            message: 'At creation you may purchase up to level 1 of any skill not granted by your archetype.',
            phase: 'creation',
            appliesTo: {},
            maxLevel: 1,
